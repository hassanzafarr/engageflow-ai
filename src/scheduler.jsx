...
import { Calendar, Check, Send, Wand, Clock, Bolt, Repeat, Linkedin, Xtwitter } from './icons.jsx';
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7">
            <Reveal delay={0.18}>
              <div className="ring-grad rounded-3xl" style={{ transform: 'perspective(1400px) rotateX(8deg) rotateY(-6deg)' }}>
                  ...
                  <AnimatePresence mode="wait">
                    <motion.div
                      ...
                      <div className="flex items-center justify-between mb-2">
                        <div className="flex items-center gap-2">
                          <span className={`w-7 h-7 rounded-lg grid place-items-center ${active.net === 'in' ? 'bg-[#0a66c2]/20 text-[#67aaf0]' : 'bg-white/10 text-white/80'}`}>
