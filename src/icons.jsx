...
export const Sparkles     = (p) => <I {...p}><path d="M12 3l1.6 4.6L18 9l-4.4 1.4L12 15l-1.6-4.6L6 9l4.4-1.4L12 3z"/><path d="M19 14l.8 2.2L22 17l-2.2.8L19 20l-.8-2.2L16 17l2.2-.8L19 14z"/><path d="M5 4l.6 1.6L7 6l-1.4.4L5 8l-.6-1.6L3 6l1.4-.4L5 4z"/></I>;
export const Bolt         = (p) => <I {...p}><path d="M13 2L4 14h7l-1 8 9-12h-7l1-8z"/></I>;
export const Chrome       = (p) => <I {...p}><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="4"/><line x1="21.17" y1="8" x2="12" y2="8"/><line x1="3.95" y1="6.06" x2="8.54" y2="14"/><line x1="10.88" y1="21.94" x2="15.46" y2="14"/></I>;
export const Play         = (p) => <I {...p}><polygon points="6 4 20 12 6 20 6 4"/></I>;
export const ArrowRight   = (p) => <I {...p}><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></I>;
export const ArrowUpRight = (p) => <I {...p}><line x1="7" y1="17" x2="17" y2="7"/><polyline points="7 7 17 7 17 17"/></I>;
...
export const Wand         = (p) => <I {...p}><path d="M15 4l1 1"/><path d="M3 21l11-11"/><path d="M19 8l1 1"/><path d="M14 3l1 1"/><path d="M19 14l1 1"/><path d="M9 5l1 1"/></I>;
...
export const History      = (p) => <I {...p}><path d="M3 12a9 9 0 1 0 3-6.7L3 8"/><polyline points="3 3 3 8 8 8"/><polyline points="12 7 12 12 15 14"/></I>;
export const Settings     = (p) => <I {...p}><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 1 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 1 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 1 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 1 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"/></I>;
...
export const Eye          = (p) => <I {...p}><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8S1 12 1 12z"/><circle cx="12" cy="12" r="3"/></I>;
export const Brain        = (p) => <I {...p}><path d="M9.5 3a3 3 0 0 0-3 3v.2A3 3 0 0 0 4 9v.5A2.5 2.5 0 0 0 4 14v.5A3 3 0 0 0 6.5 18a3 3 0 0 0 3 3 2.5 2.5 0 0 0 2.5-2.5V5.5A2.5 2.5 0 0 0 9.5 3z"/><path d="M14.5 3a3 3 0 0 1 3 3v.2A3 3 0 0 1 20 9v.5a2.5 2.5 0 0 1 0 4.5v.5a3 3 0 0 1-2.5 3 3 3 0 0 1-3 3 2.5 2.5 0 0 1-2.5-2.5V5.5A2.5 2.5 0 0 1 14.5 3z"/></I>;
export const Quote        = (p) => <I {...p}><path d="M3 21c3 0 7-1 7-8V5c0-1.25-.756-2.017-2-2H4c-1.25 0-2 .75-2 2v7c0 1.25.75 2 2 2h4"/><path d="M14 21c3 0 7-1 7-8V5c0-1.25-.756-2.017-2-2h-4c-1.25 0-2 .75-2 2v7c0 1.25.75 2 2 2h4"/></I>;
...
export const ThumbsUp     = (p) => <I {...p}><path d="M14 9V5a3 3 0 0 0-3-3l-4 9v11h11.28a2 2 0 0 0 2-1.7l1.38-9A2 2 0 0 0 19.72 9H14z"/><line x1="7" y1="22" x2="7" y2="11"/></I>;
export const ThumbsDown   = (p) => <I {...p}><path d="M10 15v4a3 3 0 0 0 3 3l4-9V2H5.72a2 2 0 0 0-2 1.7l-1.38 9A2 2 0 0 0 4.28 15H10z"/><line x1="17" y1="2" x2="17" y2="13"/></I>;
export const Smile        = (p) => <I {...p}><circle cx="12" cy="12" r="10"/><path d="M8 14s1.5 2 4 2 4-2 4-2"/><line x1="9" y1="9" x2="9.01" y2="9"/><line x1="15" y1="9" x2="15.01" y2="9"/></I>;
...
export const Mic          = (p) => <I {...p}><rect x="9" y="2" width="6" height="11" rx="3"/><path d="M19 10v1a7 7 0 0 1-14 0v-1"/><line x1="12" y1="18" x2="12" y2="22"/><line x1="8" y1="22" x2="16" y2="22"/></I>;
...
export const Sun          = (p) => <I {...p}><circle cx="12" cy="12" r="4"/><path d="M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M4.93 19.07l1.41-1.41M17.66 6.34l1.41-1.41"/></I>;
export const Moon         = (p) => <I {...p}><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></I>;
export const Linkedin     = (p) => <I {...p} stroke={0} fill="currentColor"><path d="M4 4h4v16H4zM6 2.5a2 2 0 1 1 0 4 2 2 0 0 1 0-4zM10 8h4v2.2c.6-1.1 2-2.4 4.3-2.4 4.6 0 5.7 3 5.7 6.8V20h-4v-4.6c0-1.6-.5-3-2.3-3-1.8 0-2.7 1.4-2.7 3V20h-4V8z"/></I>;
export const Xtwitter     = (p) => <I {...p} stroke={0} fill="currentColor"><path d="M17.53 3H20.5l-6.49 7.41L21.5 21h-5.92l-4.64-6.07L5.6 21H2.62l6.94-7.93L2.4 3h6.07l4.2 5.55L17.53 3zm-1.04 16h1.64L7.61 5H5.85L16.49 19z"/></I>;
